...
st.markdown("""
    ...
    section.main.css-k1vhr4.egzxvld3 > div > div:nth-child(1) > div > div
    {
        background-color: #F0F2F6;
    }
    section.main.css-k1vhr4.egzxvld3 > div > div:nth-child(1) > div > div:nth-child(1) > div 
    {
        background-color: white;
    }
    section.main.css-k1vhr4.egzxvld3 > div > div:nth-child(1) > div > div:nth-child(2)
    {
        background-color: white;
    }
    section.main.css-k1vhr4.egzxvld3 > div > div:nth-child(1) > div > div > div.css-bzyszk.e1tzin5v2
    {
        margin: auto;
        display: flex;
    }
    section.main.css-k1vhr4.egzxvld3 > div > div:nth-child(1) > div > div > div.css-bzyszk.e1tzin5v2 > div:nth-child(1) > div > div > div > div
    {
   ...
   section.main.css-k1vhr4.egzxvld3 > div > div:nth-child(1) > div > div > div.css-o7qwft.e1tzin5v2 > div:nth-child(1) > div > div:nth-child(2) > div > div > p 
    ...
    section.main.css-k1vhr4.egzxvld3 > div > div:nth-child(1) > div > div > div.css-yksnv9.e1tzin5v2 
    {
        display: flex;
        margin: auto;
    }
