...
def get_all_companies():
    ...
    data = fetch(session, f"https://is484-team6-api.onrender.com/get_companies")
    return data
...
def add_company(cid, com_name):
    ...
    data = post(session, f"https://is484-team6-api.onrender.com/add_company", body)
    return data
...
def add_file(cid, file, type):
    ...
    data = post(session, f"https://is484-team6-api.onrender.com/insert_file", body)
    return data

# GET ALL COMPNIES FILES
def get_allFiles():
    session = requests.Session()
    data = fetch(session, f"https://is484-team6-api.onrender.com/get_allFiles")
    return data
...
def insert_data(fid, cid, data):
    ...
    data = post(session, f"https://is484-team6-api.onrender.com/insert_data", body)
    return data
...
def retrieve_data(cid):
    ...
    data = post(session, f"https://is484-team6-api.onrender.com/retrieve_data", body)
    return data
...
def get_dict():
    session = requests.Session()
    data = fetch(session, f"https://is484-team6-api.onrender.com/get_dict")
    return data
...
def add_synonym(did, synonym):
    ...
    data = post(session, f"https://is484-team6-api.onrender.com/add_synonym", body)
    return data